...
function ListenSpawn(cmd, options) {
  // Fallback options
  options = options || {};
  ...
  // Generate a child singleton that invokes the command in an interactive bash shell
  // TODO: Add conditional here for if Windows
  var child = new SingleChild('bash', ['-i', '-c', cmd], options);
  this.child = child;
